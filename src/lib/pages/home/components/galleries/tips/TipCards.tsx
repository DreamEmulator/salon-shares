    ...
    <Box as="section" py="12" p="6" rounded="md">
      <Box maxW={{ base: "xl", md: "6xl" }} mx="auto" px={{ md: "8" }}>
        ...
        >
          ...
          <Testimonial
            logo={<Icon as={GiMeal} boxSize={6} />}
            tipTitle="Khoresh Fesenjan"
            tipGiver="Tip van Jop & the Persian Mama"
            colorScheme="green"
            link="https://persianmama.com/chicken-in-walnut-pomegranate-sauce-khoresht-fesenjan/"
            image="https://persianmama.com/wp-content/uploads/2014/11/fesenjan-first.jpg"
          >
            Heerlijke Persische lente maaltijd geïnspireerd door de
            granaatappel. Hoogst tijd om te gaan kokkerellen!
          </Testimonial>
          <Testimonial
            logo={<Icon as={FaMusic} boxSize={6} />}
            tipTitle="NTS Radio: Don't Assume"
            tipGiver="Tip van Laura"
            colorScheme="red"
            link="https://www.nts.live"
            image="https://images.vice.com/noisey/content-images/article/join-jaime-326-jon-rust-and-dobie-for-nts-radios-2nd-birthday-on-saturday-20-april/acfc57d059b93ee397d5724d9ad7bc57.jpg?crop=0.65625xw:1xh;center,center"
          >
            Laura's TIP voor leuke live Radio muziek optredens als je af en toe
            verrast wil worden : NTS Radio
          </Testimonial>
        </SimpleGrid>
      </Box>
    </Box>
